...
Pull request are the best way to provide a bug fix or to propose enhancements to the KunstmaanCookieBundle. This guide will show you how to get started.

## Step 1: Get the source

Start by forking the [repository](https://github.com/Kunstmaan/KunstmaanCookieBundle) and add the following to the `composer.json` file of your project:
...
```
	...
	{
	    "type": "vcs",
	    "url": "https://github.com/USERNAME/KunstmaanCookieBundle"
	}
    ],
```
...
```
git remote add upstream https://github.com/Kunstmaan/KunstmaanCookieBundle.git
```
...
You can now make a pull request on the `Kunstmaan/KunstmaanCookieBundle` GitHub repository.
